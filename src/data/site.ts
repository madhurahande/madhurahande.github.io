export const site = {
  ...
  email: 'madhurahande18@gmail.com',
  phone: '+91 8605805221',
  ...
  heroPitch: [
    ...
    // //"My interest in embedded systems began with a simple question: how does software enable hardware to sense, decide and interact with the world? That curiosity led me from robotics competitions and instrumentation engineering to developing firmware for safety-critical medical devices.",

    // "Today, I develop embedded software for real-world systems while exploring real-time computing, embedded Linux, signal processing, and system architecture.",
  ...
  stats: {
    ...
    UniversityRank: 10,
    ABURoboconRank: 6,
    // Medical Devices • Robotics • Embedded Systems
      },
